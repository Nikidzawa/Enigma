...
public class ChatRoomRepository {
    ...
    public List<ChatRoomDataModel> getAllByOwner(Long ownerId) {
        ...
        i.id as individual_id, i.avatar_href, i.name, i.nickname, i.surname, i.about_me, i.birth_date, i.last_logout_dt,
        c.id as chat_id, c.type as chat_type,
        lm.id as last_message_id, lm.sender_id, lm.sent_at, lm.text, lm.is_pinned, lm.is_edited, lm.edited_at, lm.is_read,
